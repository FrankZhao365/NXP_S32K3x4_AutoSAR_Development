...
/**
* @brief          Symbolic name for the channel DioChannel_LEDG_PTD16.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_DioChannel_LEDG_PTD16 ((uint16)0x0070U)

/**
* @brief          Symbolic name for the channel DioChannel_LEDR_PTD15.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_DioChannel_LEDR_PTD15 ((uint16)0x006fU)

/**
* @brief          Symbolic name for the channel DioChannel_LEDY_PTD1.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_DioChannel_LEDY_PTD1 ((uint16)0x0061U)

/**
* @brief          Symbolic name for the channel DioChannel_LEDB_PTD0.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_DioChannel_LEDB_PTD0 ((uint16)0x0060U)
